...
export default function ConferenceDescription() {
  const highlights = [
    ...
    },
    {
      ...
      description: "All peer reviewed, accepted, and presented papers will be published with IEEE in their prestigious book series.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-800 border-b-4 border-blue-600 inline-block pb-2">
            About <span className="text-[#fd7e14]">CHAiCET 2026</span>
          </h2>
          <p className="text-gray-600 mt-3 text-lg">
            CHARUSAT International Conference on Engineering & Technology
          </p>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 mb-6 shadow-md border-l-4 border-blue-600">
            <div className="space-y-3">
              <p className="text-gray-700 leading-relaxed text-justify">
                The CHARUSAT International Conference on Engineering & Technology (CHAiCET 2026) is a
              ...
              <p className="text-gray-700 leading-relaxed text-justify">
                The CHAiCET 2026 will help in fostering connections on a global scale
