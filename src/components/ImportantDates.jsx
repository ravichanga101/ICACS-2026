      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 mt-3 text-lg">
            CHARUSAT International Conference on Engineering & Technology (CHAiCET)
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-4 mb-6">
            {importantDates.map((item, index) => (
              ...
              >
                <div className={`bg-gradient-to-r ${item.gradient} p-3 text-white`}>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-3 rounded-lg shadow-md">
            <div className="flex items-center">
              ...
              <p className="text-gray-700 text-sm">
                <strong>Note:</strong> All dates are tentative and subject to change. Stay tuned for updates.
              </p>
            </div>
          </div>
        </div>
