  ...
  const guidelines = [
    {
      ...
      description: "The authors are invited to submit the Full Length Research/Review Papers. The papers will be peer-reviewed and only the accepted and registered papers will be considered for presentation during the conference and publication in the proceedings."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "The organizers of CHAiCET 2026 regard plagiarism as serious professional misconduct. All submissions will be screened for plagiarism and when identified, the submissions will be rejected."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "The CHAiCET 2026 doesn't encourage withdrawals after the paper is accepted."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md border-l-4 border-blue-600 p-6 mb-6">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-800">Submission Process</h3>
            </div>
          ...
          <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg shadow-md border-l-4 border-orange-500 p-6 mb-6">
            ...
            <ul className="space-y-3">
              {importantNotes.map((note, index) => (
                <li key={index} className="flex items-start">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-orange-500 mr-3 mt-0.5 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className={`text-gray-700 ${note.includes('NOTE:') ? 'font-semibold' : ''}`}>
                    {note}
                  </span>
                </li>
              ))}
          ...
          <div className="text-center">
            <a
              href="https://cmt3.research.microsoft.com/docs/help/author/author-submission-form.html" target="_blank"
